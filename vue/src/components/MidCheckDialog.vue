      ...
      <el-form :model="midCheckData"
        ...
        <el-col>
          <el-row>
            ...
            <el-col :span="24">
              <el-form-item class="item" label="课题目标" porp="midCheckGoal">
                <el-input v-model="midCheckData.midCheckGoal" type="textarea"
  ...
  methods:{
    checkType(){
      if(this.midCheckData.midCheckTeacherReview === 1){
        this.midCheckData.midCheckTeacherReview = '审核通过'
      } else if(this.midCheckData.midCheckTeacherReview === 2){
        this.midCheckData.midCheckTeacherReview = '审核驳回'
      }
      if(this.midCheckData.midCheckExpertReview === 1){
        this.midCheckData.midCheckExpertReview = '审核通过'
      } else if(this.midCheckData.midCheckExpertReview === 2){
        this.midCheckData.midCheckExpertReview = '审核驳回'
      }
      if(this.midCheckData.midCheckTeacherReview === null && this.midCheckData.groupID === sessionStorage.getItem('groupID') && sessionStorage.getItem('userType') === '2'){
        this.disableTeacher = false
        this.conditionInfo = false
      }
      if(this.midCheckData.midCheckExpertReview === null && (sessionStorage.getItem('userType') === '1' || sessionStorage.getItem('userType') === '0')){
